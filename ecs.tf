...
resource "aws_ecs_task_definition" "own_task_definition" {
  ...
  #   image_url        = "255945442255.dkr.ecr.us-east-1.amazonaws.com/leon-test-ecr-repo:latest"
  #   container_name   = "leon-test-ecs"
  #   port_name        = "leon-test-ecs-8080-tcp"
  #   log_group_region = "us-east-1"
  #   log_group_name   = "/ecs/leontesttaskdef"
